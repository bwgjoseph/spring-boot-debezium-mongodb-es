...
public class DebeziumServiceV5 {
    ...
    public DebeziumServiceV5(Executor executor, Configuration mongodbConnector, ConversionService conversionService) {
    ...
    private void handleChangeEvent(RecordChangeEvent<SourceRecord> sourceRecordRecordChangeEvent) {
        ...
        if (sourceRecordValue != null) {
            StructWrapper structWrapper = new StructWrapper(sourceRecordValue, conversionService);
